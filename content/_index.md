...
{{< hextra/feature-grid >}}
  ...
  &#8226; <a class="hx-text-[color:hsl(var(--primary-hue),100%,50%)] hx-underline hx-underline-offset-2 hx-decoration-from-font" href='{{< relref "Features/Anuncios/el-nuevo-buscador-de-problemas-de-omegaup.md" >}}'>¿Cómo buscar problemas?</a><br>
  &#8226; <a class="hx-text-[color:hsl(var(--primary-hue),100%,50%)] hx-underline hx-underline-offset-2 hx-decoration-from-font" href='{{< relref "Features/General/concursos-con-subtareas.md" >}}#cómo-crear-un-concurso-con-la-modalidad-de-subtareas'>¿Cómo crear concursos?</a><br>
